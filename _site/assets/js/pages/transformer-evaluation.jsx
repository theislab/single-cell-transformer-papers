...
function TransformerEvaluation() {
    ...
    useEffect(() => {
        ...
        .then(data => {
            ...
            if (tables?.evaluation) {
                setData(tables.evaluation);
            } else {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4">
            <h1 className="text-3xl font-bold mb-8">Transformer Evaluation</h1>
            <FilterableTable 
                data={data}
...
if (typeof document !== 'undefined') {
    document.addEventListener('DOMContentLoaded', () => {
        mountReactComponent('transformer-evaluation-root', TransformerEvaluation);
    });
}
